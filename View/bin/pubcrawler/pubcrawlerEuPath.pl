...
my $version_number = '$Revision: 2.2 $'; # '  $Date: 2004/10/06 21:48:03 $
...
foreach (keys %ncbi_options) {
    ...
    my $ncbi_buttons = "
PLease, select items in your results above to download. Or you can select ALL items clicking here.
<br>(This feature requires Javascript to be activated in your browser.)
<BR><input name=\"allbox\" type=\"checkbox\" value=\"Check All\" onClick=\"CheckAll();\">(Un)Select all boxes
<!--
<INPUT TYPE=\"button\"
     VALUE=\"toggle\"
...
for (my $i = 0; $i <= $#alias_order; $i++) {
    ...
    $result_collection .= "\n<!-- Results for $alias -->"
	.&tab('TR',' bgcolor="#507494"')
	.&tab('TD')
	."<H3><font color=\"#ffffff\">&nbsp;<A NAME=\"$quot_alias\">Results for \'$alias\' at $word</A></font></H3>"
	.&tab('/TD')
	.&tab('/TR')
	.&tab('TR')
	.&tab('TD')
...
<tr><!--#include virtual=\"/include/left-image.html\" -->
<td ALIGN=\"center\" valign=\"middle\">
<b><font face=\"Arial,Helvetica\" size=+2>&nbsp;PubMed and Entrez Updates&nbsp;</font></b>
</td>
</tr>
<tr><td colspan=\"2\">
...
#	$picture = "<A HREF=\"http://www.pubcrawler.ie\"><IMG BORDER=0 SRC=\"$PARAM{'pic'}\" ALT=\"LOGO\"></A>";
	$picture = "<A HREF=\"http://apidbdb.org\"><IMG BORDER=0 SRC=\"/images/apidblogo_m2.gif\" ALT=\"LOGO\"></A>";
    } else {
     ...
     <div>
      <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">
       <tr>
        <td bgcolor=\"#507494\">
         <div align=\"right\">
          <h3><font color=\"#ffffff\"><b>$dateline&nbsp;</b>&nbsp;&nbsp;&nbsp;&nbsp;</font></h3>
         </div>
        </td>
...
";
    ...
    my $disclaimer_header = "<H3><font color=\"#ffffff\">&nbsp;&nbsp;<A NAME=\"disclaimer\">Disclaimer and Copyright</A></font></H3>";
    my $query_box_header = "<H3><font color=\"#ffffff\">&nbsp;&nbsp;<A NAME=\"query_box\">New Query</A></font></H3>";
    my $retrieval_header = "<H3><font color=\"#ffffff\">&nbsp;&nbsp;<A NAME=\"retrieval\">Retrieval of selected items</A></font></H3>";
...
$Id: pubcrawler2.pl,v 2.2 2004/10/06 21:48:03 pubcrawl Exp pubcrawl $
