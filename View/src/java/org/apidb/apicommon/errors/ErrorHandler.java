...
public class ErrorHandler {
	...
	private static String getEmailBody(ErrorBundle errors, ErrorContext context, String logMarker) {
		...
		body.append("Remote Host: " + valueOrDefault(requestData.getRemoteHost(), "<not set>") + "\n");
		body.append("Referred from: " + valueOrDefault(requestData.getReferrer(), "<not set>") + "\n");
		...
		body.append("Request Parameters (request to the server)\n\n");
		...
		body.append(PAGE_DIV);
		body.append("Associated Request-Scope Attributes\n\n");
		...
		body.append(PAGE_DIV);
		body.append("Session Attributes\n\n");
		body.append(getAttributeMapText(context.getSessionAttributeMap()));

		// body.append(PAGE_DIV);
		// body.append("ServletContext Attributes\n\n");
