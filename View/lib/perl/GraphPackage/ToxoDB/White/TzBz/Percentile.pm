package ApiCommonWebsite::View::GraphPackage::ToxoDB::White::TzBz::Percentile;
...
sub init {
  ...
  my $_ttl  = 'expression profile percentiles of three Tgondii strains under both normal-tachyzoite and induced-bradyzoite conditoins';
