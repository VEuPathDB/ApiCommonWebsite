...
sub init {
  ...
  my $profileBase = "Transcriptional variation in Plasmodium falciparum";
  my $ref_strain = ['3d7a',]
  ...
  my @refGraph = $self->defineGraphs('Reference_3D7-A',$ref_strain, \@refColors, $profileBase, 'red percentile', \@_3d7PCH);
