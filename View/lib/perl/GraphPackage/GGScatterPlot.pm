package ApiCommonWebsite::View::GraphPackage::GGScatterPlot;
...
package ApiCommonWebsite::View::GraphPackage::GGScatterPlot::LogRatio;
use base qw( ApiCommonWebsite::View::GraphPackage::GGScatterPlot );
use strict;
...
package ApiCommonWebsite::View::GraphPackage::GGScatterPlot::ClinicalMetaData;
use base qw( ApiCommonWebsite::View::GraphPackage::GGScatterPlot );
use strict;
