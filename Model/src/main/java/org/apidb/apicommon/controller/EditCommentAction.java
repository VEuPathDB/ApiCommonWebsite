...
//        Long.valueOf(editForm.getCommentId()).longValue());
//
...
//
//    Locations[] locs = comment.getLocations();
//    String locString = "";
...
//
//    String commentPage =
//        "/addComment.do?projectId=" + projectId + "&stableId=" + stableId +
//            "&commentTargetId=" + commentTargetId + "&locType=" + "genomer" +
//            "&organism=" + comment.getOrganism() + "&locations=" + locString +
//            "&externalDbName=" + edb.getName() + "&headline=" +
//            comment.getHeadline() + "&email=" + email + pmIdString + doiString +
//            accessionsString + associatedString + "&strand=" + strand +
//            "&commentId=" + commentId + categoryString + "&content=" + content +
//            "&reviewStatus=" + comment.getReviewStatus() + fileString;
//
