...
//
//  private ArrayList<LabelValueBean> categoryList = new ArrayList<>();
//
...
//              "file upload is larger than the allowed " + maxFileSize,
//              "(total for all files) contact us for further instructions"));
//      return errors;
//    }
//
//    // This will be handled by JSON schema validation
//    //    if ((getStableId() == null) || (getStableId().trim().equals(""))) {
//    //      errors.add(ActionErrors.GLOBAL_MESSAGE,
//    //          new ActionMessage("mapped.properties", "No gene name ",
...
//    //      errors.add(ActionErrors.GLOBAL_MESSAGE,
//    //          new ActionMessage("mapped.properties", "No headline ",
...
//    //      errors.add(ActionErrors.GLOBAL_MESSAGE,
//    //          new ActionMessage("mapped.properties", "No content ",
//    //              "content is required!"));
//    //      return errors;
//    //    }
//
...
//          errors.add(ActionErrors.GLOBAL_MESSAGE,
//              new ActionMessage("mapped.properties", "Invalid Gene Identifier",
//                  "In Part III, Gene Identifier \"" + related_id +
...
//        errors.add(ActionErrors.GLOBAL_MESSAGE,
//            new ActionMessage("mapped.properties", "File not found",
...
//        errors.add(ActionErrors.GLOBAL_MESSAGE,
//            new ActionMessage("mapped.properties", "No description",
...
//        errors.add(ActionErrors.GLOBAL_MESSAGE,
//            new ActionMessage("mapped.properties",
//                "description is too long (" + formNotes.get(i).trim().length() +
//                    " characters)",
...
//    }
//
//    ArrayList<MultiBox> list = CommentFactoryManager.getCommentFactory(
//        context).getMultiBoxData("category", "target_category_id",
//        "TargetCategory", "comment_target_id='" + targetId + "'");
//
