...
public abstract class IsolateViewReporter extends AbstractReporter {
  ...
  private String prepareSql(String idSql) throws WdkModelException, WdkUserException {
    ...
    sql.append(
        "     (select count(*) as total, latitude, longitude, curated_geographic_location as country ");
