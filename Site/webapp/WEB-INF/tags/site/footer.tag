...
<%-- Convert to displayable release date and copyright year --%>
...
<c:if test="${refer ne 'home' and refer ne 'home2' and refer ne 'customSummary'}">
	      </div> <%-- class="innertube"   --%>
    ...
    <imp:dialogs/>
		...
		<div id="footer">
			<div style="float:left;padding-left:9px;padding-top:9px;">
		 	 	...
		 	 	&copy;${copyrightYear} The EuPathDB Project Team
			</div>
