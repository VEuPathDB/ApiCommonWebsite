...
<table width="100%">
  <tr>
    <td align=center>
      ...
      <%-- <input type="button" value="Run Clustal Omega on Checked Strains" onClick="goToIsolate(this,'htsSNP','${attrs['primary_seq_id']}','${attrs['primary_seq_start']}','${attrs['primary_seq_end']}')" /> --%>
