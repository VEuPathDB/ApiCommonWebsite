...
<table width="100%">
  ...
  <tr>
    ...
    <input type="button" name="CheckAll" value="Check All"  onClick="checkboxAll($('input:checkbox[name=selectedFields]'))">
    <input type="button" name="UnCheckAll" value="Uncheck All" onClick="checkboxNone($('input:checkbox[name=selectedFields]'))">
    </td>
  </tr> 
</table>
