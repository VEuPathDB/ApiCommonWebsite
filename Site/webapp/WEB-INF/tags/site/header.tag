...
Welcome to ToxoDB! ToxoDB, the Toxoplasma gondii Genome resource, provides access to the draft genome sequence of the
apicomplexan parasite <i>T. gondii</i> (ME49, GT1, VEG and RH (only Chr Ia and Chr Ib) strains) and Neospora caninum (NC-Liv strain).
The whole genome shotgun sequence of T. gondii was generated by TIGR. The whole genome shotgun sequences and the corresponding
first-pass annotation of Neospora caninum were generated by the <a href="http://www.sanger.ac.uk/">Wellcome Trust Sanger Institute</a> and funded by
the <a href="http://www.bbsrc.ac.uk/">BBSRC</a>. Publications exploiting ToxoDB should provide appropriate  
<a href="<c:url value="/showXmlDataContent.do?name=XmlQuestions.About#citing"/>">acknowledgment</a> to the database developers and those scientists who have made their data available
on this site. ToxoDB is part of an NIH/NIAID funded Bioinformatics Resource Center to provide <a href="http://apidb.org/">Apicomplexan Database Resources</a>.
</div>
