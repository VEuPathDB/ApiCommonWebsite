...
<table id="booleanFilter" data-display="${YN ne null or NY ne null or NN ne null}" data-YY="${YY}" data-YN="${YN}" data-NY="${NY}" data-NN="${NN}"> 
  ...
  <tr>
    ...
    <table>
    <tr>
      <td class="${YY eq null ? 'muted' : ''}"><input name="values" type="checkbox" value="YY" ${YYdisabled} ${YYchecked} amount="${YY eq null ? 0 : YY}"/> both searches</td>
      <td class="${YN eq null ? 'muted' : ''}"><input name="values" type="checkbox" value="YN" ${YNdisabled} ${YNchecked} amount="${YN eq null ? 0 : YN}"/> just your previous search</td>
      <td class="${NY eq null ? 'muted' : ''}"><input name="values" type="checkbox" value="NY" ${NYdisabled} ${NYchecked} amount="${NY eq null ? 0 : NY}"/> just your latest search</td>
      <td class="${NN eq null ? 'muted' : ''}"><input name="values" type="checkbox" value="NN" ${NNdisabled} ${NNchecked} amount="${NN eq null ? 0 : NN}"/> neither search</td>
    </tr>
    <tr> 
