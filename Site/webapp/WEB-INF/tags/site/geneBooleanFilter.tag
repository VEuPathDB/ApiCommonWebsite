...
<c:set var="colTooltip" value="Click on 'Add Columns' to add 2 columns (at the top) that show if a transcript was returned by the previous and/or the latest search." />
