...
<div id="menu_lefttop" data-controller="eupath.setup.configureSidebar">
  ...
  <div class="menu_lefttop_drop" id="News">
    ...
    <c:if test="${project == 'FungiDB'}">
      <a class="twitter-timeline" data-chrome="nofooter"  height="50"  href="https://twitter.com/veupathdb" data-widget-id="344817818073714691"></a>
      <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
    </c:if>
...
-->
  ...
  <div class="menu_lefttop_drop">
    <ul id="education">
      <li id='edu-05'>
        <a target="_blank" href="${props.YOUTUBE_URL}">
