...
<div id="leftcolumn">
	<div class="innertube">
		<div id="menu_lefttop">
				<img src="/assets/images/TrypDB/menu_lft1.png" alt="" width="208" height="12" />
				<a class="heading" href="#">News</a>
				<div class="menu_lefttop_drop"><ul>
					<li><a href="#">TrypDBDB 3.7 is released with isolates and<em> C. muris</em> ESTs</a><br />(19 February 2008)</li>
					<li><a href="#">TrypDBDB 3.6 is released with SNP data from <em>C. parvum</em> IOWA, MD, TU114 strains</a><br />(6 December 2007)</li>
				...
				<div class="menu_lefttop_drop"><ul>
						...
						<li><a href="#"> Minnesota TrypDBsporidium parvum Genome Project</a></li>
						<li><a href="#">TrypDBsporidium hominis Research at the Virginia Commonwealth University Center for the Study of Biologial Complexity </a></li>
