 ...
 <tr>
  ...
  <form action="${CGI_URL}/geneSrt" method="post">
    ...
    <table cellpadding="4">
        ...
        <td align="center" style="width:50px;"><input name="go" value="Get Sequences" type="submit"/></td><td align="center"><input name="save" value="Save to File" type="submit"/></td></tr>
