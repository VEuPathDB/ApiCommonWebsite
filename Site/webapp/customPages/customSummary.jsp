...
<%-- showPanel() is in filter_menu.js --%>
   ...
   <li><a id="tab_basket" title="Hand picked Features" onclick="this.blur()" href="javascript:showPanel('basket')"><img style="	margin-bottom:-2px;margin-left:-10px;margin-right:3px;margin-top:-3px;" class="basket" src="/assets/images/basket_gray.png" width="16" height="16"/>Gene Basket</a></li>
