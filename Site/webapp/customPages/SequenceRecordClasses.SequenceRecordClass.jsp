...
<c:when test='${organism eq "Trypanosoma cruzi strain CL Brener"}'>
  <c:set var="reference">
...
<c:when test='${organism eq "Leishmania infantum"}'>
  <c:set var="reference">
...
<c:when test='${organism eq "Leishmania major"}'>
  <c:set var="reference">
...
<c:when test='${organism eq "Leishmania braziliensis"}'>
  <c:set var="reference">
...
<c:when test='${organism eq "Trypanosoma brucei TREU927"}'>
  <c:set var="reference">
