...
Autocompleter.Base.prototype = {
  baseInitialize: function(element, update, options) {
    ...
    if (navigator.userAgent.indexOf('Opera')>=0) {
		...
		Position.clone(this.element, this.update, {setHeight: false, offsetTop: element.offsetHeight, offsetLeft: element.offsetWidth});
    }
...
*/
  show: function() {
    ...
    if(!this.iefix && 
      ...
      new Insertion.After(this.update, 
       ...
       'style="display:none;position:absolute;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=50);" ' +
 ...
 onBlur: function(event) {
  ...
  hide: function() {
    ...
    if(Element.getStyle(this.update, 'display')!='none') this.options.onHide(this.element, this.update);
    if(this.iefix) Element.hide(this.iefix);
    this.update.scrollTop = 0;  // reset the scroll position
  },  
