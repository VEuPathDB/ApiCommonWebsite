  ...
  <c:otherwise>
    ...
    <c:choose>
      ...
      <tr class="medium">
         ...
         <td>
            <input type=radio name="phenotypeLoc" value=1>in vitro</input>
            <input type=radio name="phenotypeLoc" value=2>in vivo</input>
            <input type=radio name="phenotypeLoc" value=3>both</input>
          </td>
      </tr>
