      ...
      .load('getFilterSummary.do', data, function(response, status) {
        ...
        if ($filter.find('table').data('display')) {
          ...
          if ( $('i#tr-warning').length == 0 ){
            $( 'li#transcript-view a span' ).append( $( "<i id='tr-warning'><img src='/a/images/warningIcon2.png' style='width:16px;vertical-align:top' title='Some Genes in your combined result have Transcripts that did not meet the search criteria.' ></i>") );
          }
