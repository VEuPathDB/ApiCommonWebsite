	  ...
	  var height = (this.props.value.length * 50) + 100;
        ...
        return (
          <div id="transcriptionSummary">
            <p><b>Help</b></p>
            <p>The Transcript Expression Summary is meant to help identify experiments in which the current gene is highly regulated. Experiments are separated across the y-axis. The FPKM values of each sample within an experiment are displayed across the x-axis, which is by default Log Scale but can be changed to Linear Scale by pressing the top-left button. Samples are represented by points and summary statistics represented by the box plot. The sample names and values for an individual experiment can be toggled on and off by pressing anywhere across an experiment. Zoom in by dragging horizontally in the graph, which allows visualization of adjacent samples or smaller fold-changes. Zoom out by double-clicking within the graph.</p>
            <p><b>Plot</b></p>
