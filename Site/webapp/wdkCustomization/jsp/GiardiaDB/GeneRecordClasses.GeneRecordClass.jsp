...
<%-- DNA CONTEXT ---------------------------------------------------%>
  ...
  <c:set var="gnCtxUrl">
     /cgi-bin/gbrowse_img/giardiadb/?name=${sequence_id}:${context_start_range}..${context_end_range};hmap=gbrowseSyn;l=${dna_gtracks};width=800;embed=1;h_feat=${fn:toLowerCase(id)}@yellow;genepage=1
  </c:set>
...
http://${pageContext.request.serverName}/cgi-bin/gbrowse_img/giardiadbaa/?name=${wdkRecord.primaryKey}:1..${proteinLength};l=${protein_gtracks};width=800;embed=1;genepage=1
</c:set>
