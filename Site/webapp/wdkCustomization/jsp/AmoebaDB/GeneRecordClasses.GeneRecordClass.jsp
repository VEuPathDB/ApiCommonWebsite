...
<c:if test="${gtracks ne ''}">
  ...
  <c:set var="gnCtxUrl">
     /cgi-bin/gbrowse_img/amoebadb/?name=${contig}:${context_start_range}..${context_end_range};hmap=gbrowseSyn;l=${gtracks};width=640;embed=1;h_feat=${id}@yellow;genepage=1
  </c:set>
