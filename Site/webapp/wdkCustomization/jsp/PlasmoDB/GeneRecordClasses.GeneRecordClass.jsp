...
<c:if test="${dna_gtracks ne ''}">
  ...
  <c:set var="gnCtxUrl"> /cgi-bin/gbrowse_img/plasmodb/?name=${sequence_id}:${context_start_range}..${context_end_range};hmap=gbrowseSyn;l=${dna_gtracks};width=800;embed=1;h_feat=${fn:toLowerCase(id)}@yellow;genepage=1
  </c:set>
...
<c:if test="${isCodingGene}">
  ...
  <c:set var="proteinFeaturesUrl">
   http://${pageContext.request.serverName}/cgi-bin/gbrowse_img/plasmodbaa/?name=${id}:1..${proteinLength};l=${protein_gtracks};hmap=pbrowse;width=800;embed=1;genepage=1
   </c:set>
