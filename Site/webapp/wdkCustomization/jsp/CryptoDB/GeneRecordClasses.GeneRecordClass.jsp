...
<c:if test="${dna_gtracks ne ''}">
  ...
  <c:set var="gnCtxUrl">
     /cgi-bin/gbrowse_img/cryptodb/?name=${contig}:${context_start_range}..${context_end_range};hmap=gbrowseSyn;l=${dna_gtracks};width=800;embed=1;h_feat=${fn:toLowerCase(id)}@yellow;genepage=1
  </c:set>
...
http://${pageContext.request.serverName}/cgi-bin/gbrowse_img/cryptodbaa/?name=${wdkRecord.primaryKey}:1..${proteinLength};l=${protein_gtracks};width=800;embed=1;genepage=1
</c:set>
