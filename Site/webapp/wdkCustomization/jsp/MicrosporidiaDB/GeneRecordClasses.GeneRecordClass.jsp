...
<imp:pageFrame title="MicrosporidiaDB : gene ${id} (${prd})"
...
<%-- DNA CONTEXT ---------------------------------------------------%>
  ...
  <c:set var="gnCtxUrl">
     /cgi-bin/gbrowse_img/microsporidiadb/?name=${contig}:${context_start_range}..${context_end_range};hmap=gbrowseSyn;l=${dna_gtracks};width=800;embed=1;h_feat=${fn:toLowerCase(id)}@yellow;genepage=1
  </c:set>
  ...
  <c:set var="gnCtxImg">
    <c:set var="gbrowseUrl">
        /cgi-bin/gbrowse/microsporidiadb/?name=${contig}:${context_start_range}..${context_end_range};h_feat=${fn:toLowerCase(id)}@yellow
    </c:set>
...
http://${pageContext.request.serverName}/cgi-bin/gbrowse_img/microsporidiadbaa/?name=${id}:1..${proteinLength};l=${protein_gtracks};width=800;embed=1;genepage=1
</c:set>
