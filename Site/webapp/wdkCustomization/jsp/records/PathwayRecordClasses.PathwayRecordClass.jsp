...
<script type="text/javascript">
 ...
 <style>
  #draggable {z-index:1000;margin-left:18px;position:absolute;margin-top: 400px; background-color:white;border:1px solid black; border-radius:5px; width: 350px; padding: 0.5em; }
