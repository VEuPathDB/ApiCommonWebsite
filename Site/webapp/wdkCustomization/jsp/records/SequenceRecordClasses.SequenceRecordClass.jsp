...
<c:when test="${fn:contains(organism,'parisii') && projectId eq 'MicrosporidiaDB'}">
  <c:set var="reference">
Nematocida parisii strain ERTm1, whole genome shotgun sequence was generated by The Broad Institute Genome Sequencing Platform and obtained from GenBank (<a href="http://www.ncbi.nlm.nih.gov/nuccore/AEFF00000000">http://www.ncbi.nlm.nih.gov/nuccore/AEFF00000000</a>).
  </c:set>
</c:when>
