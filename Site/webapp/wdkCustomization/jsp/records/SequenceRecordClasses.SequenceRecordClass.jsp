...
<c:when test='${projectId eq "FungiDB" && organism eq "Rhizopus oryzae RA 99-880"}'>
  <c:set var="reference">                                             Rhizopus oryzae strain RA-99-880 genomic annotations. Source: The Broad Institute.                                        
  </c:set>
</c:when>

<c:when test='${projectId eq "FungiDB" && organism eq "Gibberella moniliformis"}'>
  <c:set var="reference">                                             Fusarium verticillioides (Gibberella moniliformis) (7600, FRC M3125, NRRL 20956) genomic annotations. Source: The Broad Institute.                                        
  </c:set>
</c:when>
