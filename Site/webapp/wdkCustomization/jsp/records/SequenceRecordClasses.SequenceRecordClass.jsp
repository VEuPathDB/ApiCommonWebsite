...
<c:when test="${fn:contains(organism,'Crithidia') && projectId eq 'TriTrypDB'}">
  <c:set var="reference">
Sequence from <i>Crithidia fasciculata</i> was generated by the Washington University Genome Center and has been provided prepublication. Permission should be obtained from Steve Beverley (beverley@borcim.wustl.edu) before publishing analyses of the sequence/open reading frames/genes on a genome scale.
  </c:set>
</c:when>
