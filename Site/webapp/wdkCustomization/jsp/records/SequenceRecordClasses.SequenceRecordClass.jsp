...
<c:when test="${fn:contains(organism,'Entamoeba moshkovskii') && projectId eq 'AmoebaDB'}">
  <c:set var="reference">
Entamoeba moshkovskii genome was sequenced at Institute of Integrative Biology, University of Liverpool, Crown Street, Liverpool L69 7ZB, UK  </c:set>
</c:when>
...
<c:when test="${fn:contains(organism,'Encephalitozoon cuniculi EC1') && projectId eq 'MicrosporidiaDB'}">
  <c:set var="reference">
Encephalitozoon cuniculi genotype 1, EcI whole genome shotgun sequence provided by Genome Sequencing Center for Infectious Disease, Broad Institute of MIT and Harvard, 7 Cambridge Center, Cambridge, MA 02142, USA
  </c:set>
</c:when>
<c:when test="${fn:contains(organism,'Encephalitozoon cuniculi EC2') && projectId eq 'MicrosporidiaDB'}">
  <c:set var="reference">
Encephalitozoon cuniculi genotype 2, EcII whole genome shotgun sequence provided by Genome Sequencing Center for Infectious Disease, Broad Institute of MIT and Harvard, 7 Cambridge Center, Cambridge, MA 02142, USA
  </c:set>
</c:when>
<c:when test="${fn:contains(organism,'Encephalitozoon cuniculi EC3') && projectId eq 'MicrosporidiaDB'}">
  <c:set var="reference">
Encephalitozoon cuniculi strain genotype 3, EcIII  whole genome shotgun sequence provided by Genome Sequencing Center for Infectious Disease, Broad Institute of MIT and Harvard, 7 Cambridge Center, Cambridge, MA 02142, USA
  </c:set>
</c:when>
<c:when test="${fn:contains(organism,'Nematocida parisii ERTm2') && projectId eq 'MicrosporidiaDB'}">
  <c:set var="reference">
Nematocida parisii strain ERTm2  whole genome shotgun sequence provided by Genome Sequencing Center for Infectious Disease, Broad Institute of MIT and Harvard, 7 Cambridge Center, Cambridge, MA 02142, USA
  </c:set>
</c:when>
<c:when test="${fn:contains(organism,'Nematocida parisii ERTm1') && projectId eq 'MicrosporidiaDB'}">
  <c:set var="reference">
Nematocida parisii ERTm1 V3 whole genome shotgun sequence provided by Genome Sequencing Center for Infectious Disease, Broad Institute of MIT and Harvard, 7 Cambridge Center, Cambridge, MA 02142, USA
  </c:set>
</c:when>
<c:when test="${fn:contains(organism,'Vavraia culicis floridensis') && projectId eq 'MicrosporidiaDB'}">
  <c:set var="reference">
Vavraia culicis strain floridensis whole genome shotgun sequence provided by Genome Sequencing Center for Infectious Disease, Broad Institute of MIT and Harvard, 7 Cambridge Center, Cambridge, MA 02142, USA
  </c:set>
</c:when>
