...
<site:queryList columns="${columns}" questions="c.p.study:C. parvum post-infection semi-quantitative Real Time PCR  (Rutherford and Kissinger labs),GeneQuestions.GenesByRtPcrFoldChange,GeneQuestions.GenesByCryptoRtpcrProfileSimilarity"/>
