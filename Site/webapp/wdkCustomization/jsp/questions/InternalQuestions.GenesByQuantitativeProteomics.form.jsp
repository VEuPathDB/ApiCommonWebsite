...
<c:set var="hostQuestions" value="T.g.study:VEG infection Time Series (H. sapien host)(Wastling),GeneQuestions.GenesByQuantProthsapREF_quantitativeMassSpec_Wastling_VEG_timecourse_Quant_host_RSRCFoldChange"/>
