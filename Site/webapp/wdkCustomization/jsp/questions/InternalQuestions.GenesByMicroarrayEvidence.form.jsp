...
<c:set var="fungiQuestions" value="Calbstudy:C.albicans antifungal activity,GeneQuestions.GenesByMicroarrayFoldChangeCalbAntiFung,GeneQuestions.GenesByMicroarrayPercentileCalbAntiFung,GeneQuestions.GenesByFoldChangePageCalbAntiFung" />
