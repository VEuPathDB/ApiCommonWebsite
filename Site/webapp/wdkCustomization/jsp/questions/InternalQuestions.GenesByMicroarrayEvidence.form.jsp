...
<c:set var="tritrypQuestions" value="L.d.study:Promastigote to Amastigote Differentiation Time Series (Myler),GeneQuestions.GenesByPromastigoteTimeSeries,GeneQuestions.GenesByExpressionPercentileLinfantum,L.i.study:Itercellular vs Axenic Amastigotes comparison (Papadopoulou),GeneQuestions.GenesByMicroArrPaGELinfantum,T.c.study:Life-Cycle Stages (Tarleton),GeneQuestions.GenesByMicroArrPaGETcruzi,GeneQuestions.GenesByExpressionPercentileTcruzi,T.b.study:Differentiation Time Series (Clayton/Matthews),GeneQuestions.GenesByTbruceiTimeSeries,GeneQuestions.GenesByExpressionPercentileTbrucei,T.b.study:Life-Cycle Stages (Parsons),GeneQuestions.GenesByMicroArrPaGETbrucei,GeneQuestions.GenesByExpressionPercentileBrucei5stg,T.b.study:Procyclic Trypanosomes Depleted of TbDRBD3 (Estevez),GeneQuestions.GenesByMicroArr_TbDRBD3,L.m.study:Developmental Stages (Beverley),GeneQuestions.GenesByMicroArrPaGELmajor" />
