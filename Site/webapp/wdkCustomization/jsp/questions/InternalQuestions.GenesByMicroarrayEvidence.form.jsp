...
<c:set var="giardiaQuestions" value="GeneQuestions.GiardiaGenesByDifferentialExpression,GeneQuestions.GiardiaGenesFoldChange,GeneQuestions.GiardiaGenesByExpressionPercentileProfile,GeneQuestions.GiardiaGenesByDifferentialExpressionTwo,GeneQuestions.GiardiaGenesFoldChangeTwo,GeneQuestions.GiardiaGenesByExpressionPercentileProfileTwo,GeneQuestions.GenesByRingqvistFoldChange,GeneQuestions.GenesByRingqvistPercentile" />
