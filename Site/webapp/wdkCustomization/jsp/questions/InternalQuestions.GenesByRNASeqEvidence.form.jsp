...
<c:set var="toxoQuestions" value="T.g.study:VEG Tachyzoite Day 3/4 (Reid),GeneQuestions.GenesByTgVegRNASeqExpressionPercentile,T.g.study:VEG/ME49 Tachyzoite Time Series (Gregory),GeneQuestions.ToxoGenesByGregoryRNASeqTsFC,GeneQuestions.ToxoGenesByGregoryRNASeqTsPct,GeneQuestions.ToxoGenesByGregoryRNASeqTsPValue,T.g.study:M4 Oocyst Time Series (Fritz/Gregory),GeneQuestions.ToxoGenesByBoothroydRNASeqOocystFC,GeneQuestions.ToxoGenesByBoothroydRNASeqOocystPct,GeneQuestions.ToxoGenesByBoothroydRNASeqOocystPValue" />
