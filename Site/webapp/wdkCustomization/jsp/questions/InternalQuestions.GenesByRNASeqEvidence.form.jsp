...
<c:set var="toxoQuestions" value="T.g.study:VEG/ME49 Tachyzoite Time Series (Diaz/Beiting/Gregory),GeneQuestions.ToxoGenesByGregoryRNASeqTsFC,GeneQuestions.ToxoGenesByGregoryRNASeqTsPct,T.g.study:M4 Oocyst Time Series (Fritz/Boothroyd),GeneQuestions.ToxoGenesByBoothroydRNASeqOocystFC,GeneQuestions.ToxoGenesByBoothroydRNASeqOocystPct,T.g.study:VEG Tachyzoite Day 3/4 (Reid),GeneQuestions.GenesByTgVegRNASeqExpressionFoldChange,GeneQuestions.GenesByTgVegRNASeqExpressionPercentile" />
