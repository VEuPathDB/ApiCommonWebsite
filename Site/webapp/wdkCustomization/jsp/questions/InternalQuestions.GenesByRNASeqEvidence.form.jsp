...
<%-- QUESTIONS --%>
<c:set var="plasmoQuestions" value="GeneQuestions.GenesByRNASeqExpressionTiming,GeneQuestions.GenesByRNASeqPfExpressionPercentile,GeneQuestions.GenesByRNASeqPfExpressionFoldChange" />
