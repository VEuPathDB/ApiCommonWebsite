...
<%-- QUESTIONS --%>
<c:set var="fungiQuestions" value="Cneostudy:Capsule Regulation,GeneQuestions.GenesByRNASeqCneoH99_Haynes_capsuleRegulation_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqCneoH99_Haynes_capsuleRegulation_rnaSeq_RSRCPercentile,Cneostudy:nrg1 KO and Overexpression,GeneQuestions.GenesByRNASeqCneoH99_OMeara_Alspaugh_H99_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqCneoH99_OMeara_Alspaugh_H99_rnaSeq_RSRCPercentile,Ncrastudy:Hyphal Growth,GeneQuestions.GenesByRNASeqNcraOR74A_hyphalgrowth_Stajich_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqNcraOR74A_hyphalgrowth_Stajich_rnaSeq_RSRCPercentile,Ncrastudy:Population Genomics,GeneQuestions.GenesByRNASeqNcraOR74A_Ellison_PopulationGenomics_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqNcraOR74A_Ellison_PopulationGenomics_rnaSeq_RSRCPercentile,Calbstudy:Comprehensive Annotation,GeneQuestions.GenesByRNASeqCalbSC5314_Snyder_comprehensiveAnnotation_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqCalbSC5314_Snyder_comprehensiveAnnotation_rnaSeq_RSRCPercentile,Spomstudy:Dicer Protein,GeneQuestions.GenesByRNASeqSpom972hm_Barraud_dicerProtein_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqSpom972hm_Barraud_dicerProtein_rnaSeq_RSRCPercentile,Ccinstudy:Hyphal Growth,GeneQuestions.GenesByRNASeqCcinOk7h130_hyphalgrowth_Stajich_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqCcinOk7h130_hyphalgrowth_Stajich_rnaSeq_RSRCPercentile,Rorystudy:Hyphal Growth,GeneQuestions.GenesByRNASeqRory99880_Stajich_hypalgrowth_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqRory99880_Stajich_hypalgrowth_rnaSeq_RSRCPercentile,Cimmstudy:Comparative Transcriptomics,GeneQuestions.GenesByRNASeqCimmRS_Taylor_ComparativeTranscriptomics_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqCimmRS_Taylor_ComparativeTranscriptomics_rnaSeq_RSRCPercentile,Cposstudy:Comparative Transcriptomics,GeneQuestions.GenesByRNASeqCposC735_Taylor_ComparativeTranscriptomics_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqCposC735_Taylor_ComparativeTranscriptomics_rnaSeq_RSRCPercentile,Phyrastudy:Condition Expression,GeneQuestions.GenesByRNASeqPhyraPr102_Phyra_rnaseq_rnaSeq_RSRC,GeneQuestions.GenesByRNASeqPhyraPr102_Phyra_rnaseq_rnaSeq_RSRCPercentile,Hyaarstudy:Infection Expression,GeneQuestions.GenesByRNASeqHyaarEmoy2_Hyaar_rnaseq_rnaSeq_RSRCPercentile"/>
...
<tr class="headerRow"><td colspan="${columns + 2}" align="center"><b>Choose a Search</b><br><i style="font-size:80%">Mouse over to read description</i></td></tr>
  ...
  <c:choose>
    ...
    <c:otherwise>  <%-- it must be the portal --%>
      <imp:queryList columns="${columns}" questions="${plasmoQuestions},${toxoQuestions},${tritrypQuestions},${giardiaQuestions},${amoebaQuestions},${hostQuestions},${microsporidiaQuestions}"/>
    </c:otherwise>
   </c:choose>
