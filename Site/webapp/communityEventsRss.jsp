...
<c:choose>
  <c:when test="${wdkModel.projectId eq 'EuPathDB'}">
    <c:set var="linkTmpl" value="${scheme}://${serverName}${contextPath}/eupathEvents.jsp"/>
  </c:when>
  <c:otherwise>
    <c:set var="linkTmpl" value="${scheme}://${serverName}${contextPath}/communityEvents.jsp"/>
  </c:otherwise>
</c:choose>
...
<c:choose>
  <c:when test="${wdkModel.projectId eq 'EuPathDB'}">
    <c:set var="self" value="${scheme}://${serverName}/ebrcevents.rss"/>
  </c:when>
  <c:otherwise>
    <c:set var="self" value="${scheme}://${serverName}/events.rss"/>
  </c:otherwise>
</c:choose>
