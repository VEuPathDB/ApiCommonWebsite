...
<imp:script src="js/fileUpload.js"/>
    ...
    If you wish to submit data privately, please <a href="<c:url value="/app/contact-us"/>" class="new-window" data-name="contact_us">Contact Us</a> and we will provide further assistance.
    <br><br>
    ...
    If the total size of your files exceeds this limit, please <a href="<c:url value="/app/contact-us"/>" class="new-window" data-name="contact_us">Contact Us</a> and we will provide further assistance.
    <br><br>
    <table>
