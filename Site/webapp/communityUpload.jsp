...
<imp:script src="js/fileUpload.js"/>
    ...
    If the total size of your files exceeds this limit, please <a href="<c:url value="/contact.do"/>" class="new-window" data-name="contact_us">Contact Us</a> and we will provide further assistance.
    <br><br>
    <table>
