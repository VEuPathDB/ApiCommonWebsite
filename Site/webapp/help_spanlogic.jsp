...
<td width="80%" style="vertical-align:middle">
  	This "relative locations" form is dense and requires some basic understanding;<br> please <a href="<c:url value="/contact.us"/>" class="new-window" data-name="contact_us"><b>Contact Us</b></a> with any questions or feedback you may have.
</td>
<td width="20%">
