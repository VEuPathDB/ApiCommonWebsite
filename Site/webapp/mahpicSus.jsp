   ...
   <div class="wdk-toggle-content">
    ...
    <img align="middle" src="images/MaHPIC_Ex04_Timeline.png" height="300px" width="500px">
	 ...
	 <ul>
	    ...
	    <li>Functional Genomics Results: Coming Soon <!--<a href="https://www.ncbi.nlm.nih.gov/sra" target="_blank" >Sequence data at SRA</a>  OR  <a href=" https://www.ncbi.nlm.nih.gov/geo/" target="_blank">Expression data at GEO--></a> </li>
	    <li>Proteomics Results: Coming Soon <!--<a href="https://massive.ucsd.edu/ProteoSAFe/static/massive.jsp" target="_blank">Expt 4 Proteomics data at MassIVE</a>  OR  <a href=" https://www.ebi.ac.uk/pride/archive/" target="_blank">Expt 4 data at PRIDE--></a></li>
	    <li>Lipidomics Results: Coming Soon <!--<a href="https://massive.ucsd.edu/ProteoSAFe/static/massive.jsp" target="_blank">Expt 4 Lipidomics data at MassIVE</a>--></li> 
	    <li>Immunology Results: Coming Soon <!--<a href="https://immport.niaid.nih.gov/immportWeb/home/home.do?loginType=full" target="_blank">Expt 4 Immunomics at ImmPort</a>--></li>
	    <li>Metabolomics Results: Coming Soon <!--<a href="https://massive.ucsd.edu/ProteoSAFe/static/massive.jsp" target="_blank">Expt 4 Metabolomics data at MassIVE</a>--></li>
	    <li>Computational Modeling Results: Coming Soon </li>
	   </ul>
	 <h4>Publication</h4>
	 <ul>
	   <li><a href="https://www.ncbi.nlm.nih.gov/pubmed/27590312">Joyner et al. Malar J. 2016 Sep 2;15(1):451.</a></li>  
	 </ul>
  </div>
  </div>	
