...
<center><h3>NIAID Contract: # HHSN272201200031C</h3></center>

  <center><p style="font-size:16px"><a href="http://www.systemsbiology.emory.edu/index.html">MaHPIC Info at Emory</a> &nbsp; &nbsp; &ndash; &nbsp; &nbsp; <a href="https://www.niaid.nih.gov/research/malaria-host-pathogen-interaction-center-mahpic">MaHPIC Info at NIH</a>&nbsp; &nbsp; &ndash; &nbsp; &nbsp;<a href="#access">Take me to the data links</a></p>
      </center> 
     ...
     <span class="more_text">
	  ...
	  <a href="http://www.systemsbiology.emory.edu/research/cores/index.html">Emory's MaHPIC site</a>. 
	   ...
	   <ul>
        ...
        <img src="images/MaHPIC_Malaria_Core.jpg" height="10px" width="10px">
        Clinical Malaria - designs and implements experimental plans involving infection of non-human primates<br>
        <img src="images/MaHPIC_Functional_Genomics_Core.jpg" height="10px" width="10px">
