...
function openOrthologFilter(strat_id, step_id){
	...
	$("body").append("<div id='query_form' class='formPopup' style='min-height:140px; display:none'><span class='dragHandle'><div class='modal_name'><h1 id='query_form_title'></h1></div><a id='close_filter_query' href='javascript:closeAll()'><img src='/assets/images/Close-X-box.png' alt='Close'/></a></span></div>");
