wdk.namespace('eupathdb.orthologPattern', function(ns, $) {
   ...
   *
   * state    - {Array} Each element is the state of the corresponding tree node
   * children - {Array} Each element is an array of indexes which are the corresponding tree node's children
   * parent   - {Array} Each element is the index of the corresponding tree node's parent
   * abbrev   - {Array} Each element is the four-letter identifier of a tree node
   * parents  - {Array} Indexes of parent nodes
   */
