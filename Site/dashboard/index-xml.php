...
require_once dirname(__FILE__) . '/lib/wdkXmlInfo.inc';
require_once dirname(__FILE__) . '/lib/apacheXmlInfo.inc';
require_once dirname(__FILE__) . '/lib/proxyXmlInfo.inc';
require_once dirname(__FILE__) . '/lib/buildXmlInfo.inc';
