...
See L<ApiComplexa::DAS::GUS>.

=head1 DESCRIPTION

ApiComplexa::DAS::GUS::Segment::Feature is a stretch of sequence that
...
package ApiComplexa::DAS::GUS::Segment::Feature;
...
@ISA = qw(ApiComplexa::DAS::GUS::Segment Bio::SeqFeatureI Bio::Root::Root);
...
=head2 new
	...
	Title	: new
	Usage	: $f = ApiComplexa::DAS::GUS::Segment::Feature->new(@args);
	Function: create a new feature object
	Returns	: new ApiComplexa::DAS::GUS::Segment::Feature object
	Args	: see below
	Status	: Internal

This method is called by ApiComplexa::DAS::GUS::Segment to create a new 
feature using information obtained from the GUS database.

The 12 arguments are positional:

	$factory	a ApiComplexa::DAS::GUS adaptor object
...
ApiComplexa::DAS::GUS::Segment::Feature implements the Bio::SeqFeatureI
...
sub gff_string { 
	...
	#my $refp = ref $parent;
	#if($refp eq 'ApiComplexa::DAS::GUS::Segment::Feature') {
		#	my $name = $parent->name;
...
sub sub_SeqFeature {
  ...
  while (my $hashref = $sth->fetchrow_hashref) {
    ...
    my $feat = ApiComplexa::DAS::GUS::Segment::Feature->new($self->factory, 
							    $self,
							    $self->ref,
...
=head2 add_subfeature()
	...
	Returns	: nothing
	Args	: a ApiComplexa::DAS::GUS::Segment::Feature object
	Status	: Public
...
=head2 clone()
	...
	Returns	: a new ApiComplexa::DAS::GUS::Segment::Feature object
	Args	: none
	Status	: Public
