...
while (my $ecMap = $sth->fetchrow_hashref()) {
  ...
  my $popUp = "<table>".
                "<tr>".
                  "<td>EC No:</td>".
                  "<td>".
                    "<a href=\"javascript:void(0)\" onclick=\"PathwayMap.goToUrl(this)\" ".
                    "   data-location=\"processQuestion.do?questionFullName=GeneQuestions.InternalGenesByEcNumber&array%28organism%29=all&array%28ec_number_pattern%29=".$$ecMap{'DISPLAY_LABEL'}."&questionSubmit=Get+Answer\">".$$ecMap{'DISPLAY_LABEL'} . " (" . $$ecMap{'DESCRIPTION'} .")".
                    "</a></td>".
                "</tr><tr>".
                  "<td>Organisms:</td>".
