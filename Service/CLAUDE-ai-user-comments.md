...
**Still stubs (throw `UnsupportedOperationException` / 501):** `InsertCommentAiProvenanceQuery.getArguments` (publish/D7), DELETE endpoint. _(`validateSummary` was removed, not stubbed — see the 2026-06-05 plan change. `persist`/`InsertCommentAiRunQuery.getArguments` are now implemented — D6.)_
