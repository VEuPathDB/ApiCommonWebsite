...
public class ApiCheckLoginFilter extends CheckLoginFilter {
  ...
  private static final List<String> OPEN_FULL_PATHS = new ListBuilder<String>()
    ...
    .addAll(List.of(
      ...
      "dataset","datasource","userdataset","junction", "variation", "user-comment"
  ...
  protected boolean isPathToSkip(String path) {
    return path.startsWith("jbrowse") || path.startsWith("jbrowse-apollo") || path.startsWith("profileSet") || super.isPathToSkip(path);
  }
